...
# get input params
params['units'] = raw_input('Channels with units? [Ch1, Ch2,...]'+os.linesep + '> ')
...
laser_dial = raw_input('Laser type and Power? ["Laser-id" "Dial-number"]'+os.linesep + '> ')
a=re.split('\s+', laser_dial)
params['laser_type'] = a[0]
...
#params['ref'] = str(int(float(syn.getParameterValue('Sel1', 'ChanSel-1'))))
